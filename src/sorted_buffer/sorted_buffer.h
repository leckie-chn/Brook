...
// key (User can decide whether sort the list). 
// Once the buffer is close to full, the content is output into
...
class SortedBuffer {
public:
    // flag = true, sort the list
    // flag = false, do not sort the list
    //
